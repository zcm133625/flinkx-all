 ...
 * @author toutian
 */
public class BinlogOracleOutputFormatBuilder extends BaseRichOutputFormatBuilder {

    protected BinLogOracleOutputFormat format;


    public BinlogOracleOutputFormatBuilder() {
        format = new BinLogOracleOutputFormat();
        super.format = format;
    }
    ...
    public void setTableMes(Map<String, List<Map<String, Object>>> tableMes) {
        this.format.tableMes = tableMes;
    }
